...
<script>
  ...
  export default {
    setup(props, context) {
      ...
      // 更改搜索框颜色
      const chenge = (e) => {
        iptcolor.value=data.bannerList[e.detail.current].background
      }
      /* 获取中部导航列表数据 */
      getList().then(res => {
        // console.log(res.data);
