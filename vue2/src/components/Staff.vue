  ...
  <div class="member-wrapper">
    ...
    <el-card class="box-card">
      ...
      <template>
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="mobile" label="员工电话" >
          </el-table-column>
          <el-table-column prop="salary" label="员工薪酬" >
          </el-table-column>
          <el-table-column prop="entryDate" label="员工入职时间">
          </el-table-column>
    ...
    <el-dialog title="会员编辑" :visible.sync="editDialogFormVisible">
      <el-form :model="editForm">
        ...
        <el-form-item label="入职时间" :label-width="formLabelWidth">
          <el-input v-model="editForm.entryDate" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
